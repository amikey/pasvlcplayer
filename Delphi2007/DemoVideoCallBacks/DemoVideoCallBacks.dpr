...
procedure libvlc_video_unlock_cb(ctx : Pointer; picture : Pointer; planes : Pointer); cdecl;
begin
end;

procedure libvlc_video_display_cb_RV32(ctx : Pointer; picture : Pointer); cdecl;
var
  y        : Integer;
  src      : PByte;
