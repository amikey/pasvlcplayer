(*
 *******************************************************************************
 * PasLibVlcPlayerUnit.pas - VCL component for VideoLAN libvlc 2.2.2
 *
...
type
  ...
  TNotifyAudioVolume      = procedure(Sender : TObject; volume          : Single)  of object;
  ...
  private
    ...
    FOnMediaPlayerAudioVolume      : TNotifyAudioVolume;
    ...
    procedure WmMediaPlayerAudioVolume     (var m: TVlcMessage); message WM_MEDIA_PLAYER_AUDIO_VOLUME;
  ...
  public
    ...
    function  GetpasVlcInstance() : TPasLibVlc;
    ...
    procedure Play       (mrl: WideString; audioOutput: WideString = ''; audioOutputDeviceId: WideString = ''; audioSetTimeOut: Cardinal = 1000);
    procedure PlayNormal (mrl: WideString; audioOutput: WideString = ''; audioOutputDeviceId: WideString = ''; audioSetTimeOut: Cardinal = 1000);
    ...
    procedure PlayContinue(audioOutput: WideString = ''; audioOutputDeviceId: WideString = ''; audioSetTimeOut: Cardinal = 1000);
  ...
  published
    ...
    property OnMediaPlayerAudioVolume : TNotifyAudioVolume
      read  FOnMediaPlayerAudioVolume
      write FOnMediaPlayerAudioVolume;
...
function TPasLibVlcPlayer.GetpasVlcInstance: TPasLibVlc;
var
  oIdx : Integer;
begin
  if not Assigned(FVLC) then
...
procedure TPasLibVlcPlayer.WmMediaPlayerAudioVolume(var m: TVlcMessage);
var
  value: Single;
begin
  if Assigned(FOnMediaPlayerAudioVolume) then
  begin
    value := (m.WParam / 1000);
    FOnMediaPlayerAudioVolume(SELF, value);
  end;
  m.Result := 0;
end;
