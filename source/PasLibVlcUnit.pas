(*
 *******************************************************************************
 * PasLibVlcUnit.pas - pascal interface for VideoLAN libvlc 2.2.2
 *
...
procedure libvlc_dynamic_dll_init();overload;
procedure libvlc_dynamic_dll_init(libPath:String);overload;
...
type
  media_player_audio_volume_t = packed record
    volume : Single; // float
  end;
...
type
  libvlc_video_format_cb = function (
    ...
    var lines : LongWord) : LongWord; cdecl;
...
procedure libvlc_dynamic_dll_init(libPath:String);
begin
  if (libvlc_handle <> 0 ) then exit;
  libvlc_dynamic_dll_init_with_path(libPath);
end;
