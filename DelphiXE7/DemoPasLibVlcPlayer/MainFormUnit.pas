...
type
  TMainForm = class(TForm)
    ...
    procedure PasLibVlcPlayer1MediaPlayerAudioVolume(Sender: TObject;
      volume: Single);
...
procedure TMainForm.PasLibVlcPlayer1MediaPlayerAudioVolume(Sender: TObject;
  volume: Single);
var
...
begin
   self.PasLibVlcPlayer1.GetpasVlcInstance.Path:=getcurrentDir+'\'    ;
end;
